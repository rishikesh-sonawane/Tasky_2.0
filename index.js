...
const generateHTML = (taskData) =>
  ...
  <div class="card bg-dark">
    <div class="card-header d-flex justify-content-end gap-2">
      <button type="button" class="btn btn-outline-secondary" onclick="editCard.apply(this, arguments)">
    ...
    <div class="card-body bg-secondary">
      ...
      <span class="badge bg-dark mb-3">${taskData.type}</span>
    </div>
    <div class="card-footer">
        <button type="button" class="btn btn-outline-secondary" name=${taskData.id} data-bs-toggle ="modal" data-bs-target="#showTask" onclick="openTask.apply(this , arguments)">
          Open Task
        </button>
      </div>
  </div>
